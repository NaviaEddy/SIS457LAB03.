...
#define UE_PROJECT_NAME BricksBreaker
#define UE_TARGET_NAME BricksBreakerEditor
#define UE_MODULE_NAME "BricksBreaker"
...
#define BRICKSBREAKER_API DLLEXPORT
